<!DOCTYPE html>
<html>
<head><title>Dashboard Kurir</title>
<!-- Tambahkan ini di semua dashboard agar popup logout & berhasil login jalan -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
</head>
<body style="background-color:#f0fff4; font-family:sans-serif; text-align:center; padding-top:50px;">
    <h1>HALAMAN DASHBOARD KURIR</h1>
    <p>Kurir Aktif: <b><?= $this->session->userdata('name') ?></b></p>
    <hr>
