<!DOCTYPE html>
<html>
<head><title>Dashboard Gudang</title>
<!-- Tambahkan ini di semua dashboard agar popup logout & berhasil login jalan -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
</head>
<body style="background-color:#fffaf0; font-family:sans-serif; text-align:center; padding-top:50px;">
    <h1>HALAMAN DASHBOARD STAFF GUDANG</h1>
    <p>Petugas: <b><?= $this->session->userdata('name') ?></b></p>
    <hr>
